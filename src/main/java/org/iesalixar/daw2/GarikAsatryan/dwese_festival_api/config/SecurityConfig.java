...
import org.iesalixar.daw2.GarikAsatryan.dwese_festival_api.services.CustomUserDetailsService;
...
public class SecurityConfig {
     ...
     * ADMIN hereda permisos de MANAGER, y MANAGER hereda permisos de USER.
     *
     * @return una instancia de {@link RoleHierarchy} con la jerarquía configurada.
     */
    @Bean
    ...
    /**
     * Aplica la jerarquía de roles a las anotaciones de seguridad en métodos
     * como @PreAuthorize, @Secured, etc.
     *
     * @param roleHierarchy la jerarquía de roles configurada.
     * @return una instancia de {@link MethodSecurityExpressionHandler} con la jerarquía aplicada.
     */
    @Bean
